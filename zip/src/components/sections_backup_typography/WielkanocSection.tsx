          ...
          <div className="max-w-7xl mx-auto space-y-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 items-start">
              ...
              <div className="space-y-8">
                <h2 className="font-headline text-4xl tracking-[0.3rem] uppercase leading-tight">Wielkanoc w Bulwarze</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 items-center">
              ...
              <div className="space-y-8 order-1 lg:order-2">
                <h2 className="font-headline text-4xl tracking-[0.3rem] uppercase leading-tight">Catering Wielkanocny</h2>
                <div className="w-12 h-[1px] bg-primary"></div>
                <p className="text-zinc-500 font-body text-sm leading-relaxed">

      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between border-b border-outline-variant/30 pb-6 space-y-6 md:space-y-0">
          <div className="flex flex-col w-full md:w-1/4">
            <label className="font-label text-xs uppercase text-zinc-500 mb-2">Guests</label>
          ...
          <div className="flex flex-col w-full md:w-1/4">
            <label className="font-label text-xs uppercase text-zinc-500 mb-2">Date</label>
          ...
          <div className="flex flex-col w-full md:w-1/4">
            <label className="font-label text-xs uppercase text-zinc-500 mb-2">Time</label>
          ...
          <Button className="w-full md:w-auto bg-primary text-on-primary px-8 py-4 font-label uppercase text-sm hover:opacity-80 transition-opacity rounded-[4px]">
            BOOK A TABLE
          </Button>
        </div>
      </div>

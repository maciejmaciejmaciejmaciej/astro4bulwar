    ...
    <section className="bg-surface py-32">
      <div className="theme-section-wrapper">
        <div className="flex justify-between items-end mb-16">
          <h2 className="font-headline text-3xl uppercase">ANDÉ BLOG</h2>
          <a className="font-label text-xs uppercase border-b border-primary pb-1" href="#">VIEW ALL</a>
        </div>
        <div className="grid md:grid-cols-3 gap-12">
          <div className="group cursor-pointer">
            ...
            <span className="font-label text-xs text-zinc-500 uppercase mb-2 block">06.06.2018</span>
            <h3 className="font-headline text-xl mb-4 group-hover:underline underline-offset-8 decoration-1">GARLIC PASTA</h3>
            <a className="font-label text-xs uppercase text-primary" href="#">DISCOVER</a>
          </div>
          <div className="group cursor-pointer">
            <div className="aspect-[4/3] overflow-hidden mb-6 rounded-[4px]">
            ...
            <span className="font-label text-xs text-zinc-500 uppercase mb-2 block">12.06.2018</span>
          ...
          <div className="group cursor-pointer">
            ...
            <span className="font-label text-xs text-zinc-500 uppercase mb-2 block">18.06.2018</span>

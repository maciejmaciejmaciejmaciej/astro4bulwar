          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
            <motion.div variants={fadeInUp} className="lg:col-span-2">
              <div className="space-y-8">
                ...
                <h2 className="font-headline text-4xl md:text-5xl lg:text-6xl uppercase">
                  Organic Resonance
                </h2>
                <p className="max-w-2xl font-body text-sm text-zinc-500">
            ...
            >
              <div className="space-y-4 border-l border-zinc-200 pl-8">
                <div className="flex justify-between items-center">
                  <span className="font-label text-xs uppercase text-zinc-500">Museum</span>
                  <span className="font-headline text-sm uppercase">
                    MOMA NYC
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-label text-xs uppercase text-zinc-500">Year</span>
                  <span className="font-headline text-sm uppercase">
                    2024
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-label text-xs uppercase text-zinc-500">Medium</span>
                  <span className="font-headline text-sm uppercase">
                    Sculpture
                  </span>
                </div>

...
This block renders the Promo2 lower menu panel as a standalone page-builder section with a centered heading and a three-column grid.

It is intended for cases where the page needs:

- the Promo2 lower menu-row typography
- a three-column menu layout
...
- three menu columns on larger screens
- no media element
...
- when `source` is set:
  ...
  - the block keeps the fixed three-column split
